...
/// EditExpenseScreen - Form to edit an existing expense.
/// Receives the ExpenseModel as a route argument.
...
class _EditExpenseScreenState extends State<EditExpenseScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_initialized) {
      _expense = ModalRoute.of(context)!.settings.arguments as ExpenseModel;
      _amountController =
          TextEditingController(text: _expense.amount.toStringAsFixed(2));
      _descriptionController =
          TextEditingController(text: _expense.description);
      ...
      _selectedFrequency =
          _expense.recurringFrequency ?? ExpenseModel.recurringFrequencies[2];
      // Parse time string "HH:mm"
      final timeParts = _expense.time.split(':');
